        ...
        {banners.map((banner) => (
          <div
            ...
            <div
              ...
              <div className='text-[#F3F3F3] space-y-3 md:space-y-5 lg:space-y-7 ml-5 md:ml-20 lg:ml-24 md:w-[60%] lg:w-[40%]'>
                ...
                <div className='space-y-3 md:space-y-0 md:space-x-5 font-semibold text-lg '>
                  <button className='px-6 py-4 rounded-md bg-[#2ECA7F] border-2 border-[#2ECA7F]'>
                    Book Now
                  </button>
                </div>
              </div>
